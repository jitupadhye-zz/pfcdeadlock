...
\centering
\subfigure[Topology and flows] {
    \includegraphics[width=0.3\textwidth] {figs/case1_topo.pdf}
}
\subfigure[Buffer dependency graph]{
    \includegraphics[width=0.21\textwidth] {figs/case1_buffer_dependency.pdf}
}
\subfigure[Pause events at four links]{
    \includegraphics[width=0.22\textwidth] {figs/case1_pause.eps}
}
...
% expired; 2) or it has received a resume frame from this ingress queue.
  ...
  \textbf{Simulation setup}: \textcolor{red}{To create a well-controlled experimental environment,
...
\subfigure[Topology and flows] {
    \includegraphics[width=0.3\textwidth] {figs/case2_topo}
}
\subfigure[Buffer dependency graph]{
    \includegraphics[width=0.22\textwidth] {figs/case2_buffer_dependency}
}
\subfigure[Pause events at four links]{
    \includegraphics[width=0.24\textwidth] {figs/case2_pause.eps}
}
\vspace{-0.15in}
...
\subfigure[Pause events at four links]{
    \includegraphics[width=0.24\textwidth] {figs/pause_event_limit2G.eps}
}
\subfigure[2Gbps rate limiter, no deadlock]{
    \includegraphics[width=0.24\textwidth] {figs/buffer_occupancy_B_limit2G.eps}
}
\subfigure[3Gbps rate limiter, deadlock]{
    \includegraphics[width=0.24\textwidth] {figs/buffer_occupancy_B_limit3G.eps}
}
\vspace{-0.15in}
...
\para{Slightly different traffic matrix leads to deadlock:} \textcolor{red}{as shown in Figure~\ref{fig:case2}(a), based on the previous scenario, we
