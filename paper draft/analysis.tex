\section{Circular Buffer Dependency is Insufficient for Deadlock}\label{sec:casestudy}

\subsection{Injection and Drain Rate}

\subsection{Packet-level Behavior}
