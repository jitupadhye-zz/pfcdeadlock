...
\subfigure[Pause events at four links]{
    \includegraphics[width=0.26\textwidth] {figs/case1_pause.eps}
}
...
\subfigure[Topology and flows] {
    \includegraphics[width=0.33\textwidth] {figs/case2_topo}
}
\subfigure[Buffer dependency graph]{
    \includegraphics[width=0.24\textwidth] {figs/case2_buffer_dependency}
}
\subfigure[Pause events at four links]{
    \includegraphics[width=0.27\textwidth] {figs/case2_pause.eps}
}
\vspace{-0.15in}
