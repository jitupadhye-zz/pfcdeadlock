...
\end{figure*}
 ...
 In our simulations, link capacity of all links is 40Gbps. All the switches have 12MB buffer. 
...
\textbf{Case 1:} In this case, as shown in Fig.~\ref{fig:case1}(a), we let two flows run over four 
...
Buffer dependency graph of case 1 is drawn in Fig.~\ref{fig:case1}(b). Each directed line represents 
...
\textbf{Case 2:} as shown in Fig.~\ref{fig:case2}(a), in the second case, in addition to case 1, we 
...
\subfigure[Buffer occupancy of flow 2 at switch A.] {
    \includegraphics[width=0.32\textwidth] {figs/case3_buffer_occupancy_A.eps}
}
\subfigure[Buffer occupancy of flow 1 at switch B.] {
    \includegraphics[width=0.32\textwidth] {figs/case3_buffer_occupancy_B1.eps}
}
\subfigure[Buffer occupancy of flow 3 at switch B.] {
    \includegraphics[width=0.32\textwidth] {figs/case3_buffer_occupancy_B3.eps}
}
...
Pause events at four links L1, L2, L3 and L4 are plotted In Fig.~\ref{fig:case3}(c).  As we can see 
...
\para{Summary.} In the multi-flow scenarios, cyclic buffer dependency can be created without 
