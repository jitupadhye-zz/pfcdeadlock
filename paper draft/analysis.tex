\section{Cyclic Buffer Dependency is not a sufficient condition for Deadlock}\label{sec:casestudy}
...
\subfigure[Buffer dependency graph.]{
    \includegraphics[width=0.37\textwidth] {figs/loop_case_ingress_buffer_dependency}
}
