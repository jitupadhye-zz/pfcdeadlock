...
(unexpected) flooding of lossless class traffic. \revise{This case is a concrete example to show that even for tree-based topology, cyclic buffer dependency can still occur if up-down routing is not strictly followed.} Furthermore, there are multiple
