...
\para{PFC may lead to deadlock, if paused links form a loop.}
...
\para{Unfortunately, achieving deadlock-free routing has high price, and may not
even be viable.} Previous work achieves deadlock-free routing by eliminating
