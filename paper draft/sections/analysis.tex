...
\subfloat[short for lof][Topology and flows.] {
    \includegraphics[width=0.35\textwidth] {figs/case2_topo}
}
\subfloat[short for lof][Buffer dependency.]{
    \includegraphics[width=0.3\textwidth] {figs/case2_buffer}
}
\subfloat[short for lof][Pause events at four links.]{
...
\caption{Deadlock case 2.}\label{fig:case1}
...
\subfloat[short for lof][Topology and flows.] {
    \includegraphics[width=0.35\textwidth] {figs/case3_topo}
}
\subfloat[short for lof][Buffer dependency.]{
    \includegraphics[width=0.3\textwidth] {figs/case3_buffer}
}
\subfloat[short for lof][Pause events at four links.]{
...
\caption{Deadlock case 3.}\label{fig:case1}
